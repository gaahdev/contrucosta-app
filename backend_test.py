...
def main():
    ...
    tests = [
        ...
        ("Assigned Driver Registration", tester.test_assigned_driver_registration),
        ("Unassigned Driver Registration", tester.test_unassigned_driver_registration),
        ("Helper Registration", tester.test_helper_registration),
        ("Checklist Template", tester.test_checklist_template),
        ("Checklist Template Helper Access", tester.test_checklist_template_helper_access),
        ("Current Checklist", tester.test_checklist_current),
        ("Checklist Submit Incomplete", tester.test_checklist_submit_incomplete),
        ("Checklist Submit Complete", tester.test_checklist_submit_complete),
        ("Dashboard Checklist Status", tester.test_dashboard_checklist_blocking),
        ("Helper Dashboard No Checklist", tester.test_helper_dashboard_no_checklist),
        ("Admin View Checklists", tester.test_admin_checklists),
